...
describe("typed views — per schema (inline minimal shapes)", () => {
  const cases: readonly { schema: string; raw: Record<string, unknown>; expect: string }[] = [
    ...
    {
      schema: "phase7.authorization.audit.v1",
      raw: {
        schemaVersion: "phase7.authorization.audit.v1",
        verdict: "authorized-for-design-only",
        auditId: "ex",
        repoSha: "e607238",
        auditedAt: "2026-06-13T00:00:00.000Z",
        auditedMode: "phase7-live-authorization-review",
        gateCount: 14,
        gates: [{ gateId: "env-acknowledgment", name: "g", defaultState: "blocked", evidenceSource: "live-gate.ts", failClosedProven: true, testCoverageRef: "t.ts", status: "verified", blocker: null }],
        noSendInvariant: { status: "verified", evidence: "x", detail: "resolver fail-closed" },
        signerBoundary: { status: "verified", evidence: "x", detail: null },
        rustBoundary: { status: "verified", evidence: "x", detail: null },
        artifactRedaction: { status: "verified", evidence: "x", detail: null },
        releaseCandidate: { status: "verified", evidence: "x", detail: null },
        reconciliationWall: { status: "verified", evidence: "x", detail: null },
        commandSurface: { status: "safe", evidence: "x", detail: "no mainnet-send command" },
        microTradePrerequisites: [{ id: "devnet-broadcast-confirmed", description: "d", met: false, detail: "faucet blocked" }],
        remainingBlockers: [],
        nextSafeAction: "close the open prerequisites; Phase 7 stays unauthorized",
        caveats: ["authorizes nothing"],
      ...
      expect: "does NOT execute trades",
    },
    {
      schema: "phase7.microtrade.preflight.v1",
      raw: {
        schemaVersion: "phase7.microtrade.preflight.v1",
        preflightId: "ex",
        repoSha: "c04a51b",
        generatedAt: "2026-06-13T00:00:00.000Z",
        mode: "controlled-mainnet-microtrade-preflight",
        network: "mainnet-beta",
        preflightVerdict: "ready-for-separate-execution-authorization",
        ...
        burnerWalletAddress: "8FenZasyRe3HeUEm4X8iTAufaamnryU2JB8cRzWyHgwm",
        maxSpendCapLamports: 1_000_000,
        maxSpendCapSol: 0.001,
        ...
        killSwitchStatus: "required-at-execution",
        reconciliationRequirement: "required-post-trade",
        missingRequirements: [],
        nextSafeAction: "a separate, explicit S104 execution authorization is still required",
        caveats: ["authorizes nothing"],
