...
program
  ...
  .option("--escalation-armed", "mark the escalation session as manually re-armed (still gated by every other check; never a bypass)")
    ...
    (opts: {
      ...
      const { text, exitCode } = liveSniperRunReport(
        {},
        {
          ...
          armed: Boolean(opts.escalationArmed),
          spendSol: opts.spendSol,
